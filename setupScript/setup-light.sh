...
sudo apt-get -qy install hadoop-datanode zookeeper
...
sudo sed -i -e "s*<configuration>*<configuration>\n  <property>\n    <name>fs.default.name</name>\n    <value>hdfs://$2:8020</value>\n  </property>*" /etc/hadoop/conf/core-site.xml
...
sudo sed -i -e "s*<value>localhost:2181</value>*<value>$2:2181</value>*" accumulo-site.xml
